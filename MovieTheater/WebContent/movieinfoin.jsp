...
<div class="w3-main w3-padding w3-dark-grey" style="margin-left:300px" id="main">
  ...
  <header id="portfolio">
    ...
    <form>
      <button class="w3-button w3-khaki w3-round-large" type="submit" formaction="homepagein.jsp"><i class="fa fa-home w3-margin-right"></i>Home</button>
    </form>
    	<div class="signinbtn">
    		<form>
    	...
    	</div><div class="signupbtn">
    		<form>
        		<button class="subtn w3-button w3-round-large" type="submit" formaction="Signup.jsp">Sign Up<i class="fa fa-sign-in w3-margin-left"></i></button>
    		</form>
    	</div>
    </div>
    </div>
