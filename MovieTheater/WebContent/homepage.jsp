<%@ page  import="java.time.format.DateTimeFormatter" import="java.text.*" import="java.time.LocalDate" import="controller.Control" import="model.Movie" import="model.User" language="java" contentType="text/html; charset=ISO-8859-1"
...
<div class="w3-main w3-padding w3-dark-grey" style="margin-left:300px" id="main">
  ...
  <table>
    ...
    <tr>
      ...
      <td><form method="POST"><button class="w3-button w3-black w3-round" value="<%=u.screening.elementAt(i).getId()%>"
      	 name="buy" formaction="Purchase">Purchase</button></form></td>
